...
how $ \asecret $ can be obfuscated, via selecting to share
only particular features of $ \asecret $, to protect Bob from guessing
the output of a blacklis function $ B $ while maintaining
that the whitelist function $ W $ is computable.
